...
1. audio record -> play with equalizer.
...
4. AmebaGreen2(for mixer architecture, please set menuconfig.py->Config Link Option->Img2 Code In Psram_DataHeapInSram, only support SW_EQ_VERSION_0_0)
...
2. Here's a simple demo of recording through microphone and playing recorded sound through speaker with equalizer:
   ```
   equalizer -r 48000 -c 2 -f 16
   ```